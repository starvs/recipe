...
func CreateDummyRecipe() {
	ingredient0 := domain.Ingredient{Name: "chicken", Quantity: 1, Unit: "lb."}
	ingredient1 := domain.Ingredient{Name: "chicken", Quantity: 2, Unit: "lb."}
	ingredient2 := domain.Ingredient{Name: "rice", Quantity: 8, Unit: "oz."}
	ingredient3 := domain.Ingredient{Name: "rice", Quantity: 300, Unit: "grams"}
	...
	recipe := domain.Recipe{Name: "chicken and rice", Ingredients: []*domain.Ingredient{&ingredient0, &ingredient2}, Tags: []*domain.Tag{&tag1, &tag2}, PrepTime: 8, BakeTime: 30}
